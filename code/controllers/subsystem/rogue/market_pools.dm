...
/proc/get_navigator_bucket_for_category(category)
	switch(category)
		...
		if(ITEM_CAT_TOOLS_FIELD, ITEM_CAT_TOOLS_WORKSHOP, ITEM_CAT_TOOLS_SUNDRIES, ITEM_CAT_TOOLS_ROGUE, ITEM_CAT_SMITHING_MISC)
			return NAVIGATOR_BUCKET_TOOLS
		if(ITEM_CAT_VALUABLES_RINGS, ITEM_CAT_VALUABLES_HOLY, ITEM_CAT_DECORATION, ITEM_CAT_TOOLS_COOKWARE)
		...
		if(ITEM_CAT_RAW_MATERIAL_MINERAL, ITEM_CAT_RAW_MATERIAL_ORGANIC, ITEM_CAT_SALVAGE, ITEM_CAT_LIVESTOCK, ITEM_CAT_COMPONENTS)
...
/proc/get_navigator_bucket_pool_baseline(bucket)
	switch(bucket)
		...
		if(NAVIGATOR_BUCKET_TOOLS)
			return NAVIGATOR_BUCKET_POOL_TOOLS
...
/proc/get_navigator_bucket_theme(bucket)
	switch(bucket)
		...
		if(NAVIGATOR_BUCKET_VALUABLES_CRAFTED, NAVIGATOR_BUCKET_VALUABLES_LOOTED, NAVIGATOR_BUCKET_CARVED, NAVIGATOR_BUCKET_POTTERY, NAVIGATOR_BUCKET_TROPHIES, NAVIGATOR_BUCKET_INSTRUMENTS)
			return MARKET_THEME_LOOT
		if(NAVIGATOR_BUCKET_ENGINEERING, NAVIGATOR_BUCKET_TOOLS)
			return MARKET_THEME_ENGINEERING
	return MARKET_THEME_MISC
