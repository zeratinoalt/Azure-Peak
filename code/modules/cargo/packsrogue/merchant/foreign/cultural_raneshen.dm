/datum/supply_pack/rogue/raneshen
	group = "Cultural Stock"
	crate_name = "Raneshen crate"
	crate_type = /obj/structure/closet/crate/chest/merchant
	not_in_public = TRUE

/datum/supply_pack/rogue/raneshen/janissary_kit
	name = "Ranesheni Janissary Harness"
...
// Bronze "Thespian-Errant" stock - gladiatorial gear out of the arenas of Raneshen and Lirvas.
...
/datum/supply_pack/rogue/raneshen/bronze_winged_spear
	...
	cost = 85
	contains = list(/obj/item/rogueweapon/spear/bronze/winged)
	ship_qty_min = 1
	ship_qty_max = 3
...
/datum/supply_pack/rogue/raneshen/arbelos
	name = "Arbelos Axegauntlet"
	cost = 75
	contains = list(/obj/item/rogueweapon/katar/bronze/gladiator)
	ship_qty_min = 1
	ship_qty_max = 2
...
/datum/supply_pack/rogue/raneshen/bronze_sling_bullets
	name = "Pouch of Bronze Sling Bullets"
	cost = 35
