...
/datum/supply_pack/rogue/underdark/stalker_falx
	name = "Stalker Falx"
	cost = 85
...
/datum/supply_pack/rogue/underdark/stalker_dagger
	name = "Stalker Dagger"
	cost = 45
	contains = list(/obj/item/rogueweapon/huntingknife/idagger/steel/stalker)

/datum/supply_pack/rogue/underdark/stalker_dirk
	name = "Stalker Dirk"
	cost = 55
	contains = list(/obj/item/rogueweapon/huntingknife/idagger/steel/corroded/dirk)
...
/datum/supply_pack/rogue/underdark/drowcraft_vest
	name = "Drowcraft Vest"
	cost = 75
	contains = list(/obj/item/clothing/suit/roguetown/armor/leather/heavy/shadowvest)
