	...
	switch (action)
		...
		if ("remove")
			...
			if (!ban)
				...
				return
			if (alert(usr, "Are you sure you want to remove the sticky ban on [ckey]?","Are you sure","Yes","No") == "No")
				return
			if (!get_stickyban_from_ckey(ckey))
		...
		if ("exempt")
			...
			if (alert(usr, "Are you sure you want to exempt [alt] from [ckey]'s sticky ban?","Are you sure","Yes","No") == "No")
				return
		...
		if ("unexempt")
			...
			if (alert(usr, "Are you sure you want to unexempt [alt] from [ckey]'s sticky ban?","Are you sure","Yes","No") == "No")
				return
		...
		if ("timeout")
			...
			if (alert(usr, "Are you sure you want to put [ckey]'s stickyban on timeout until next round (or removed)?","Are you sure","Yes","No") == "No")
				return
			var/ban = get_stickyban_from_ckey(ckey)
			if (!ban)
				to_chat(usr, span_adminnotice("Error: No sticky ban for [ckey] found!"))
		...
		if ("untimeout")
			...
			if (alert(usr, "Are you sure you want to lift the timeout on [ckey]'s stickyban?","Are you sure","Yes","No") == "No")
				return
		...
		if ("revert")
			if (!data["ckey"])
				return
			var/ckey = data["ckey"]
			if (alert(usr, "Are you sure you want to revert the sticky ban on [ckey] to its state at round start (or last edit)?","Are you sure","Yes","No") == "No")
				return
			var/ban = get_stickyban_from_ckey(ckey)
			if (!ban)
				to_chat(usr, span_adminnotice("Error: No sticky ban for [ckey] found!"))
