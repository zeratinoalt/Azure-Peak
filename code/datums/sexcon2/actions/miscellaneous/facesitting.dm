...
/datum/sex_action/miscellaneous/facesitting/shows_on_menu(mob/living/carbon/human/user, mob/living/carbon/human/target)
	if(user == target)
		return FALSE
...
/datum/sex_action/miscellaneous/facesitting/can_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	if(!.)
		return FALSE
	if(user == target)
...
/datum/sex_action/miscellaneous/facesitting/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
...
/datum/sex_action/miscellaneous/facesitting/on_perform_message(mob/living/carbon/human/user, mob/living/carbon/human/target)
	var/datum/sex_session/sex_session = get_sex_session(user, target)
	var/do_subtle = sex_session.doing_subtly
